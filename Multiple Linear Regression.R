...
#MLR
mlrmodel1 = lm(formula = sales ~ price + promotion, data=omni) #Multiple Linear Model 
#mlrmodel2 = lm(formula = sales ~ price, data=omni) #Simple Linear Model

summary(mlrmodel1)
#All 3 are significant since, pvalue less than 0.05 and all got 3 starred.
#Adjusted R-Squared: 74% of variation in Sales is explained by price and promotion. 
#Equation is: Sales  = 5837.5208 + (-53.2173)Price + (3.6131)Promotion
#If no star is there, don't take that variable, it is insignificant.
